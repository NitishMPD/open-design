...
- `packages/headless-runtime`: reusable shell-neutral lifecycle primitives for the Headless product. It coordinates injected daemon/Web adapters, product health/diagnostics, explicit paths, and reverse shutdown; deployable composition remains in `apps/headless`.
